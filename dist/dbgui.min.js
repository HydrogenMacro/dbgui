...
var module$dist$widgets={};module$dist$widgets.Widget=Widget$$module$dist$widgets;let url$$module$dist$dbgui=new URL(location.href),config$$module$dist$dbgui={fontSize:url$$module$dist$dbgui.searchParams.get("fontSize")||"14"};const dbguiRowClass$$module$dist$dbgui="__DBGUI_INJECTED_row",dbguiCategoryClass$$module$dist$dbgui="__DBGUI_INJECTED_category",dbguiSummaryClass$$module$dist$dbgui="__DBGUI_INJECTED_summary",styleTag$$module$dist$dbgui=document.createElement("style");styleTag$$module$dist$dbgui.innerHTML=`.${dbguiRowClass$$module$dist$dbgui}:nth-of-type(2n):not(.${dbguiCategoryClass$$module$dist$dbgui}),.${dbguiRowClass$$module$dist$dbgui}.${dbguiCategoryClass$$module$dist$dbgui}:nth-of-type(2n)>summary{background-color:rgb(200 200 200) !important;}.${dbguiSummaryClass$$module$dist$dbgui}::marker{all: revert !important;}`;
